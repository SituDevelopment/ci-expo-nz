                            ...
                            {({ selectedIndex }) => (
                                <>
                                    {scheduleData.days?.map((day, dayIndex) => (
                                        ...
                                        >
                                            <div>
                                                <h3 className="text-primary-900 flex items-center text-2xl font-semibold tracking-tight">
                            ...
                            >
                                <div className="flex items-baseline gap-2">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-primary-900 dark:text-primary-700 mt-1.5 text-base tracking-tight">
                                            {day.sessions?.length}{" "}
